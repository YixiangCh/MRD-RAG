...
1. Import our DI-Tree KB into neo4j. The dump files are availeble <a href="DI-Tree KB">here</a>. You can use the following command to dump our KB into your own neo4j database.
